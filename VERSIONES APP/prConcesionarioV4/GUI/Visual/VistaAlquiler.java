...
public class VistaAlquiler extends JFrame {
       		...
       		.addGroup(groupLayout.createSequentialGroup()
       			...
       			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
       				.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
       					...
       					.addGap(18)
       					.addComponent(jScrollPane2, GroupLayout.PREFERRED_SIZE, 939, GroupLayout.PREFERRED_SIZE))
       				.addComponent(botonera, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 1900, Short.MAX_VALUE))
       			.addContainerGap())
       		.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
       	...
       	groupLayout.createParallelGroup(Alignment.LEADING)
       		.addGroup(groupLayout.createSequentialGroup()
       			...
       			.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
       				.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 868, GroupLayout.PREFERRED_SIZE)
       				.addComponent(jScrollPane2, GroupLayout.PREFERRED_SIZE, 868, GroupLayout.PREFERRED_SIZE))
       			.addGap(18)
       			.addComponent(botonera, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
       			.addContainerGap())
       );
    ...
    private void initComponents() {
        ...
        tablaClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            botonera.setBackground(new Color(175, 238, 238));
