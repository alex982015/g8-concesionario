  ...
  public VistaGestorVehiculosMecanico(int id,String r) {
      ...
      gl_panel.setHorizontalGroup(
      	gl_panel.createParallelGroup(Alignment.LEADING)
      		.addGroup(gl_panel.createSequentialGroup()
      			...
      			.addGap(18)
      			.addComponent(txtc, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
      			.addGap(18)
      			.addComponent(texto_Disp)
      			.addGap(18)
      			.addComponent(txtDisp, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
      			.addGap(18)
      ...
      groupLayout.setHorizontalGroup(
      	groupLayout.createParallelGroup(Alignment.LEADING)
      		...
      		.addGroup(groupLayout.createSequentialGroup()
      			.addGap(10)
      			.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 1899, GroupLayout.PREFERRED_SIZE))
      		.addGroup(groupLayout.createSequentialGroup()
      			.addContainerGap()
      ...
      groupLayout.setVerticalGroup(
      	groupLayout.createParallelGroup(Alignment.LEADING)
      		.addGroup(groupLayout.createSequentialGroup()
      			...
      			.addGap(1)
      			.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 939, GroupLayout.PREFERRED_SIZE)
