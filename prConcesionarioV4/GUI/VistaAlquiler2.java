...
public class VistaAlquiler2 extends JFrame {
	...
	public VistaAlquiler2(int codV, int codC, int id, String rol) {
		//extender tamaÃ±o ventana al maximo de la pantalla
	...
	private void initComponents() {
		...
		texto_NumDias.setText("NÃºmero de dÃ­as:");
		...
		texto_Vehiculo.setText("DATOS DEL VEHÃ�CULO");
		...
		texto_Kilometros.setText("KilÃ³metros:");
		...
		texto_Anyo.setText("AÃ±o de fabricaciÃ³n:");
		...
		panel1.setBorder(javax.swing.BorderFactory.createTitledBorder("DATOS DEL VEHÃ�CULO"));
		          ...
		          .addGroup(jpanel3Layout.createSequentialGroup()
		              ...
		              .addGroup(jpanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
		                  .addGroup(jpanel3Layout.createSequentialGroup()
		                      ...
		                      .addGap(18, 18, 18)
		                      .addGroup(jpanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
		                          .addComponent(txtFechaActual,javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
		                          .addComponent(txtNumDias,javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void fichaVehiculo(int codigoV) {
		...
		// a travÃ©s del id se muestra el vehiculo
        String sql = "SELECT * FROM vehiculo WHERE idVehiculo = '" + codigoV + "'";
        ResultSet rs = null;
        PreparedStatement ps = null;
        try{
		//conectamos a la base de datos, para que a travÃ©s del codigo del vehÃ­culo nos devuelva todas las variables
	...
	//metodo ficha cliente a travÃ©s del cÃ³digo
	private void fichaCliente(int codigoC) {
		...
		//conectamos a la base de datos
            ps = conec.getConnection().prepareStatement(sql);
            rs = ps.executeQuery();
		//a travÃ©s del id nos devolvera todas la variables
	...
	//boton volver, volvemos a la pestaÃ±a anterior
