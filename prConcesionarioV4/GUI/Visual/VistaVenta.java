       			...
       			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
       				.addGroup(groupLayout.createSequentialGroup()
       					...
       					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
       						.addGroup(groupLayout.createSequentialGroup()
       							.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 942, GroupLayout.PREFERRED_SIZE)
       							.addGap(18)
       							.addComponent(jScrollPane2))
       						.addComponent(botonera, GroupLayout.PREFERRED_SIZE, 1900, GroupLayout.PREFERRED_SIZE)))
       				.addGroup(groupLayout.createSequentialGroup()
       					.addGap(826)
       					.addComponent(title, GroupLayout.PREFERRED_SIZE, 266, GroupLayout.PREFERRED_SIZE)))
       	...
       	groupLayout.createParallelGroup(Alignment.LEADING)
       		.addGroup(groupLayout.createSequentialGroup()
       			...
       			.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
       				...
       				.addComponent(jScrollPane2, GroupLayout.PREFERRED_SIZE, 882, GroupLayout.PREFERRED_SIZE))
       			.addGap(18)
       			.addComponent(botonera, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE))
       );
